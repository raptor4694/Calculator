...
@AllArgsConstructor
public class ExpressionYPostfixDecrement implements
		ExpressionPostfixDecrement, ExpressionVectorElement {
	Expression array;
	...
	public String toCompiledString() {
		return "<<.Y %s> DEC>".format(
				(Object) array.toCompiledString());
	}
	
	@Override
	public String toString() {
		return "YPostfixDecrement{array=%s}".format(array);
	}
