...
public class ExpressionLocal implements Expression {
	...
	public static class DefImpl implements Def {
		...
		public Object eval(Scope scope) {
			Object result =
					(value == null)? Real.ZERO : value.eval(scope);
		...
		@Override
		public String toString() {
			return "DefImpl{name=\"%s\",value=%s}".format(
					(Object) name, value);
		}
	...
	public static class DimDef extends ExpressionDimAssign
			implements Def {
		...
		@Override
		protected Predicate<String> getHasVariableFunction(
				Scope scope) {
		...
		@Override
		public String toString() {
			return "DimDef{variable=\"%s\",value=%s}".format(
	...
	public static class FuncDef extends ExpressionFunctionDefinition
			implements Def {
