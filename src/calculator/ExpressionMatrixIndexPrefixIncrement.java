...
public class ExpressionMatrixIndexPrefixIncrement extends
		ExpressionMatrixIndex implements ExpressionPrefixIncrement {
	
	public ExpressionMatrixIndexPrefixIncrement(Expression matrix,
	...
	public Object eval(Scope scope) {
		...
		return matrix[row][column] =
				matrix[row][column].plus(Real.ONE);
	}
