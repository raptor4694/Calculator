...
@AllArgsConstructor
public class ExpressionXPrefixDecrement
	...
	public Object eval(Scope scope) {
		...
		return array[0] = array[0].minus(Real.ONE);
	}
	...
	public String toCompiledString() {
		return "<DEC <.X %s>>".format((Object) array.toCompiledString());
	}
	
	@Override
	public String toString() {
		return "XPrefixDecrement{array=%s}".format(array);
	}
