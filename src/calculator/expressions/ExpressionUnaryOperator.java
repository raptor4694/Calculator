...
public class ExpressionUnaryOperator implements Expression {
	...
	public ExpressionUnaryOperator(EnumOperator operator, Expression expr) {
		if (operator.cardinality != 1)
			throw new IllegalArgumentException("Operator cardinality is not 1");
	...
	public String toString() {
		return "UnaryOperator{operator=%s,expr=%s}".format(operator, expr);
	}
