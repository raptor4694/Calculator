...
public class ExpressionAssignOp implements ExpressionNamed {
	...
	public String toEvalString() {
		return "%s %s= %s".format((Object) variable, operator.getSymbol(),
				expr.toEvalString());
	}
	...
	public String toCompiledString() {
		...
		case ADD:
		case SUBTRACT:
			return "<%s %s %s \"%s\">".format(operator, expr.toCompiledString(),
					operator.getVerb(), variable);
		default:
			return "<%s \"%s\" %s %s>".format(operator, variable, operator.getVerb(),
