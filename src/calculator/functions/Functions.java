...
import static calculator.functions.Operations.*;
import static calculator.functions.Operators.*;
...
public @UtilityClass class Functions {
	...
	public boolean toBoolean(Number d) {
	...
	public boolean toBoolean(Object[] array) {
		if (array.length == 0)
			return false;
		for (Object d : array)
			if (toBoolean(d))
	...
	public boolean toBoolean(Object[][] matrix) {
		if (matrix.length == 0)
			return false;
